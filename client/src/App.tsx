  ...
  return (
    <>
        ...
        <section id="home" className="hero section">
          <div className="container hero-inner reveal">
            ...
            <h1 className="hero-title">
              Hi, I'm{' '}
              <span className="text-accent">Martin Kojo Quayson</span>.
              <br />
          ...
          <div className="container">
            ...
            <div className="project-grid">
              <article className="project-card reveal">
                <div
                  className="project-card-image placeholder-image"
                  aria-hidden="true"
                >
                  <span>01</span>
                </div>
                ...
                <div className="project-card-body">
                  ...
                  <p>
                    A responsive personal site built with semantic HTML and
                    modern CSS — my foundation project as I grow toward
        ...
        <section id="about" className="section section-alt">
          <div className="container about-grid reveal">
            <div className="about-photo">
              <img
                ...
                onError={(e) => {
                  ...
                  if (t.src.includes('.jpg')) {
                    t.src = '/assets/photo.jpeg'
                  }
                }}
              />
            </div>
            ...
            <div className="about-content">
              ...
              <p>
                Right now I'm focused on strong fundamentals: clean HTML,
                thoughtful CSS, and JavaScript basics. Each project in this
                portfolio is deliberate practice toward that long-term goal.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="section section-alt">
          <div className="container contact-inner reveal">
            <header className="section-header reveal">
              ...
              <h2>Let's connect</h2>
              <p className="section-intro">
                Open to feedback, collaboration, and junior opportunities.
              </p>
            </header>

            <div className="contact-links">
              <a className="contact-link" href="mailto:mquayson49@gmail.com">
                mquayson49@gmail.com
              </a>

              <a
                className="contact-link"
                href="https://github.com/mharthin"
                target="_blank"
              ...
              <a
                className="contact-link"
                href="https://linkedin.com/in/martquayson49"
                target="_blank"
                rel="noopener noreferrer"
              >
                LinkedIn
      ...
      <footer className="site-footer">
        <div className="container">
          <p>
            &copy; <span id="year">{year}</span> Martin Kojo Quayson. All
            rights reserved.
          </p>
        </div>
      </footer>
